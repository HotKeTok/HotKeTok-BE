...
public interface HouseRepository extends JpaRepository<House, Long> {
    ...
    Optional<House> findByTenantIdAndAddress(Long tenantId, String address);
    Optional<House> findByTenantIdAndAddressAndNumber(Long tenantId, String address, String number);
}
